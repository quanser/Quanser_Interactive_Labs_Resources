...
class QLabsRoundaboutSign:
    ...
    def spawnDegrees(self, qlabs, deviceNumber, location, rotation, scale, waitForConfirmation=True):
        ...
        return qlabs.spawn(deviceNumber, self.ID_ROUNDABOUT_SIGN, location[0], location[1], location[2], rotation[0]/180*math.pi, rotation[1]/180*math.pi, rotation[2]/180*math.pi, scale[0], scale[1], scale[2], 0, waitForConfirmation)
