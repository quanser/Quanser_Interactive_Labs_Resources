...
class QLabsRoundaboutSign:
    ...
    def spawn_degrees(self, qlabs, actorNumber, location, rotation, scale, waitForConfirmation=True):
        ...
        :rtype: int32
        """    
        return QLabsCommon().spawn(qlabs, actorNumber, self.ID_ROUNDABOUT_SIGN, location, [rotation[0]/180*math.pi, rotation[1]/180*math.pi, rotation[2]/180*math.pi], scale, 0, waitForConfirmation)
