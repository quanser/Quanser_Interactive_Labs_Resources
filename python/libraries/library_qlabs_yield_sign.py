...
class QLabsYieldSign(QLabsActor):
    ...
    def spawn(self, location, rotation, scale, configuration=0, waitForConfirmation=True):
        ...
        """
        return self._spawn(actorNumber, location, rotation, scale, configuration, waitForConfirmation)
    ...
    def spawn_degrees(self, location, rotation, scale, configuration=0, waitForConfirmation=True):
        ...
        """    
        return self._spawn(actorNumber, location, [rotation[0]/180*math.pi, rotation[1]/180*math.pi, rotation[2]/180*math.pi], scale, configuration, waitForConfirmation)
