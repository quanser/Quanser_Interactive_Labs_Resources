...
class QLabsYieldSign:
    ...
    def spawn(self, qlabs, location, rotation, scale, waitForConfirmation=True):
        """Spawns a yield sign in an instance of QLabs at a specific location and rotation using radians with a specified actor number.
    ...
    def spawn_degrees(self, qlabs, location, rotation, scale, waitForConfirmation=True):
        """Spawns a yield sign in an instance of QLabs at a specific location and rotation using degrees with a specified actor number.
    ...
    def spawn_id(self, qlabs, actorNumber, location, rotation, scale, waitForConfirmation=True):
        ...
        """
        return QLabsCommon().spawn_id(qlabs, actorNumber, self.ID_YIELD_SIGN, location, rotation, [1,1,1], 0, waitForConfirmation)
    ...
    def spawn_id_degrees(self, qlabs, actorNumber, location, rotation, scale, waitForConfirmation=True):
        ...
        """    
        return QLabsCommon().spawn_id(qlabs, actorNumber, self.ID_YIELD_SIGN, location, [rotation[0]/180*math.pi, rotation[1]/180*math.pi, rotation[2]/180*math.pi], scale, 0, waitForConfirmation)
