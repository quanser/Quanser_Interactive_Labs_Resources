...
class QLabsStopSign(QLabsActor):
    ...
    def spawn(self, location, rotation, scale, configuration=0, waitForConfirmation=True):
        """Spawns a stop sign in an instance of QLabs at a specific location and rotation using radians with a specified actor number.
        ...
        """
        return self._spawn(location, rotation, scale, 0, waitForConfirmation)
 
    def spawn_degrees(self, location, rotation, scale, configuration=0, waitForConfirmation=True):
        """Spawns a stop sign in an instance of QLabs at a specific location and rotation using degrees with a specified actor number.
        ...
        return self._spawn(location, [rotation[0]/180*math.pi, rotation[1]/180*math.pi, rotation[2]/180*math.pi], scale, 0, waitForConfirmation)
    ...
    def spawn_id(self, actorNumber, location, rotation, scale, configuration=0, waitForConfirmation=True):
        ...
        """
        return self._spawn_id(actorNumber, location, rotation, scale, 0, waitForConfirmation)
    ...
    def spawn_id_degrees(self, actorNumber, location, rotation, scale, configuration=0, waitForConfirmation=True):
        ...
        return self._spawn_id(actorNumber, location, [rotation[0]/180*math.pi, rotation[1]/180*math.pi, rotation[2]/180*math.pi], scale, 0, waitForConfirmation)
