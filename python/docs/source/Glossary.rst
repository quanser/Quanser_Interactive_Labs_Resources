...
.. glossary::
    ...
    QCar
        ...
        and controller using MATLAB/Simulink or Python development environments. It can enrich your 
        lectures and activities in traditional labs, or bring credible, authentic model-based lab 
        experiences into your distance and online self-driving course. Same as the physical QCar,  
    ...
    Configuration
        Some actors have more then one 3D animations called configurations. For instance, in the animal
        class, there is different configurations for different animals. See the configurations section 
        under the Actors Reference to see all configurations a particular actor class. 
