function Container = AeroMakeCommandStateContainer(DeviceNumber, Yaw, Pitch, Motor0Speed, Motor1Speed, BaseColor_v3) %#codegen

%skip size for now

Container = flip(typecast(int32(90), 'uint8')); %Device ID
