function [Location, Forward, Up, BumpForward, BumpLeft, BumpRight, Gyro, Heading, EncoderLeft, EncoderRight] = QBot3DecodeUE4StateContainer(Payload, StartIndex) %#codegen
