function Container = RotaryFlexLinkMakeCommandStateContainer(DeviceNumber, MotorAngle, AccessoryAngle) %#codegen

%skip size for now

Container = flip(typecast(int32(41), 'uint8')); %Device ID
