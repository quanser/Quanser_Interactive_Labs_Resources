function Container = QubeMakeCommandStateContainer(DeviceNumber, MotorAngle, PendulumAngle, BaseColor_v3) %#codegen

%skip size for now

Container = flip(typecast(int32(60), 'uint8')); %Device ID
