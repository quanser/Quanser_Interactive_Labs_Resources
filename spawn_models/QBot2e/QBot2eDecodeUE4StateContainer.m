function [Location, Forward, Up, BumpForward, BumpLeft, BumpRight, Gyro, Heading, EncoderLeft, EncoderRight] = QBot2eDecodeUE4StateContainer(Payload, StartIndex) %#codegen
