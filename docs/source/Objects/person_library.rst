...
.. autoclass:: python.qvl.person.QLabsPerson
...
.. autoattribute:: python.qvl.person.QLabsPerson.ID_PERSON
.. autoattribute:: python.qvl.person.QLabsPerson.STANDING
.. autoattribute:: python.qvl.person.QLabsPerson.WALK
.. autoattribute:: python.qvl.person.QLabsPerson.JOG
.. autoattribute:: python.qvl.person.QLabsPerson.RUN
...
.. autoattribute:: python.qvl.person.QLabsPerson.actorNumber
...
.. automethod:: python.qvl.person.QLabsPerson.__init__
.. automethod:: python.qvl.person.QLabsPerson.spawn
.. tip::
...
.. automethod:: python.qvl.person.QLabsPerson.spawn_degrees
.. tip::
...
.. automethod:: python.qvl.person.QLabsPerson.spawn_id
.. tip::
    The origin of the person is in the center of the body so by default, it
    will be spawned 1m above the surface of the target.
    An additional vertical offset may be required if the surface is sloped to
...
.. automethod:: python.qvl.person.QLabsPerson.spawn_id_degrees
.. tip::
    The origin of the person is in the center of the body so by default, it
    will be spawned 1m above the surface of the target.
    An additional vertical offset may be required if the surface is sloped to
...
.. automethod:: python.qvl.person.QLabsPerson.move_to
.. automethod:: python.qvl.person.QLabsPerson.destroy
.. automethod:: python.qvl.person.QLabsPerson.destroy_all_actors_of_class
.. automethod:: python.qvl.person.QLabsPerson.ping
.. automethod:: python.qvl.person.QLabsPerson.get_world_transform
.. automethod:: python.qvl.person.QLabsPerson.get_world_transform_degrees
