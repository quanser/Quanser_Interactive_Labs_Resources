...
.. autoclass:: python.qvl.animal.QLabsAnimal
...
.. autoattribute:: python.qvl.animal.QLabsAnimal.ID_ANIMAL
.. autoattribute:: python.qvl.animal.QLabsAnimal.GOAT
.. autoattribute:: python.qvl.animal.QLabsAnimal.SHEEP
.. autoattribute:: python.qvl.animal.QLabsAnimal.COW
.. autoattribute:: python.qvl.animal.QLabsAnimal.GOAT_STANDING
.. autoattribute:: python.qvl.animal.QLabsAnimal.GOAT_WALK
.. autoattribute:: python.qvl.animal.QLabsAnimal.GOAT_RUN
.. autoattribute:: python.qvl.animal.QLabsAnimal.SHEEP_STANDING
.. autoattribute:: python.qvl.animal.QLabsAnimal.SHEEP_WALK
.. autoattribute:: python.qvl.animal.QLabsAnimal.SHEEP_RUN
.. autoattribute:: python.qvl.animal.QLabsAnimal.COW_STANDING
.. autoattribute:: python.qvl.animal.QLabsAnimal.COW_WALK
.. autoattribute:: python.qvl.animal.QLabsAnimal.COW_RUN
...
.. autoattribute:: python.qvl.animal.QLabsAnimal.actorNumber
...
.. automethod:: python.qvl.animal.QLabsAnimal.__init__
.. automethod:: python.qvl.animal.QLabsAnimal.spawn
.. tip::
...
.. automethod:: python.qvl.animal.QLabsAnimal.spawn_degrees
.. tip::
    The origin of the animal is in the center of the body so by default, it
    will be spawned 1m above the surface of the target.
    An additional vertical offset may be required if the surface is sloped to
...
.. automethod:: python.qvl.animal.QLabsAnimal.spawn_id
.. tip::
    The origin of the animal is in the center of the body so by default, it
    will be spawned 1m above the surface of the target.
    An additional vertical offset may be required if the surface is sloped to
...
.. automethod:: python.qvl.animal.QLabsAnimal.spawn_id_degrees
.. tip::
    The origin of the animal is in the center of the body so by default, it
    will be spawned 1m above the surface of the target.
    An additional vertical offset may be required if the surface is sloped to
...
.. automethod:: python.qvl.animal.QLabsAnimal.move_to
.. automethod:: python.qvl.animal.QLabsAnimal.destroy
.. automethod:: python.qvl.animal.QLabsAnimal.destroy_all_actors_of_class
.. automethod:: python.qvl.animal.QLabsAnimal.ping
.. automethod:: python.qvl.animal.QLabsAnimal.get_world_transform
.. automethod:: python.qvl.animal.QLabsAnimal.get_world_transform_degrees
